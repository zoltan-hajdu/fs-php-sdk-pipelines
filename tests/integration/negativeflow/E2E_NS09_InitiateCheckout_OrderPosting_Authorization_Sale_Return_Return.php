...
class E2E_NS09_InitiateCheckout_OrderPosting_Authorization_Sale_Return_Return
{
    public static function test_E2E_NS09($spreadSheet = 'TestData')
    {
        ...
        try {
            ...
            $testData = $readExcel->getTestData("$spreadSheet.xls",
                "InitiateCheckout",
                "E2E_NS09_InitiateCheckout_OrderPosting_Authorization_Sale_Return_Return");
            ...
            if (!is_null($orderPostingResponse)) {
                AuthorizationAPI::forMReturn($orderPostingResponse, $testData, $saleTestData, $returnTestData);
            }
            ...
            $_SESSION['stepData'][] =
                $reportHandler->getErrorData("Exception Message in E2E_NS09_InitiateCheckout_OrderPosting_Authorization_Sale_Return_Return",
