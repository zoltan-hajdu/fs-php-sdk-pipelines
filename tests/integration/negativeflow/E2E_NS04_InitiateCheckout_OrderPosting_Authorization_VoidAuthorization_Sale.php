...
class E2E_NS04_InitiateCheckout_OrderPosting_Authorization_VoidAuthorization_Sale
{
    public static function test_E2E_NS04($spreadSheet = 'TestData')
    {
        ...
        try {
            ...
            $testData = $readExcel->getTestData("$spreadSheet.xls",
                "InitiateCheckout",
                "E2E_NS04_InitiateCheckout_OrderPosting_Authorization_VoidAuthorization_Sale");
            ...
            if (!is_null($orderPostingResponse)) {
                $authorizationResponse = AuthorizationAPI::forVoidAuthorization($orderPostingResponse,
                    $testData,
                    $voidTestData);
            }
            ...
            if (!is_null($orderPostingResponse)) {
                SaleAPI::perform($authorizationResponse, $saleTestData, 0);
            }
            ...
            $_SESSION['stepData'][] =
                $reportHandler->getErrorData("Exception Message in E2E_NS04_InitiateCheckout_OrderPosting_Authorization_VoidAuthorization_Sale",
