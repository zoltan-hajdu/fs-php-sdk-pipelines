...
class E2E_NS05_InitiateCheckout_OrderPosting_Authorization_Sale_VoidAuthorization
{
    public static function test_E2E_NS05($spreadSheet = 'TestData')
    {
        ...
        try {
            ...
            $testData = $readExcel->getTestData("$spreadSheet.xls",
                "InitiateCheckout",
                "E2E_NS05_InitiateCheckout_OrderPosting_Authorization_Sale_VoidAuthorization");
            ...
            if (!is_null($orderPostingResponse)) {
                $authorizationResponse = AuthorizationAPI::build($orderPostingResponse, $testData, $saleTestData);
            }
            ...
            if (!is_null($orderPostingResponse)) {
                VoidAuthorizationtestAPI::build($authorizationResponse, $voidTestData);
            }
            ...
            $_SESSION['stepData'][] =
                $reportHandler->getErrorData("Exception Message in E2E_NS05_InitiateCheckout_OrderPosting_Authorization_Sale_VoidAuthorization",
