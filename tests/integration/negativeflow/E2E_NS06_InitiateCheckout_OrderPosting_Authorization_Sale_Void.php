...
class E2E_NS06_InitiateCheckout_OrderPosting_Authorization_Sale_Void
{
    public static function test_E2E_NS06($spreadSheet = 'TestData')
    {
        ...
        try {
            ...
            $testData = $readExcel->getTestData("$spreadSheet.xls",
                "InitiateCheckout",
                "E2E_NS06_InitiateCheckout_OrderPosting_Authorization_Sale_Void");
            ...
            $_SESSION['stepData'][] =
                $reportHandler->getErrorData("Exception Message in E2E_NS06_InitiateCheckout_OrderPosting_Authorization_Sale_Void",
