...
class E2E_NS03_InitiateCheckout_OrderPosting_Authorization_Sale
{
    public static function test_E2E_NS03($spreadSheet = 'TestData')
    {
        ...
        try {
            ...
            $testData = $readExcel->getTestData("$spreadSheet.xls",
                "InitiateCheckout",
                "E2E_NS03_InitiateCheckout_OrderPosting_Authorization_Sale");
            ...
            $saleTestData = $readExcel->getTestData("$spreadSheet.xls",
                "Sale",
                "E2E_NS03_InitiateCheckout_OrderPosting_Authorization_Sale");
            $saleNTestData = $readExcel->getTestData("$spreadSheet.xls",
                "Sale_N",
                "E2E_NS03_InitiateCheckout_OrderPosting_Authorization_Sale");

            if (!is_null($orderPostingResponse)) {
                AuthorizationAPI::forMSale($orderPostingResponse, $testData, $saleTestData, $saleNTestData);
            }
            ...
            $_SESSION['stepData'][] =
                $reportHandler->getErrorData("Exception Message in E2E_NS03_InitiateCheckout_OrderPosting_Authorization_Sale",
