...
class E2E_NS10_InitiateCheckout_OrderPosting_Authorization_Sale_Return_Void_Void
{
    public static function test_E2E_NS10($spreadSheet = 'TestData')
    {
        ...
        try {
            ...
            $testData = $readExcel->getTestData("$spreadSheet.xls",
                "InitiateCheckout",
                "E2E_NS10_InitiateCheckout_OrderPosting_Authorization_Sale_Return_Void_Void");
            ...
            if (!is_null($orderPostingResponse)) {
                AuthorizationAPI::forReturnVoidVoid($orderPostingResponse,
                    $testData,
                    $saleTestData,
                    $returnTestData,
                    $voidTestData);
            ...
            $_SESSION['stepData'][] =
                $reportHandler->getErrorData("Exception Message in E2E_NS10_InitiateCheckout_OrderPosting_Authorization_Sale_Return_Void_Void",
