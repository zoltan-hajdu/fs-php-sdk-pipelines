...
class E2E_V20_InitiateCheckout_OrderPosting_Authorization_Sale
{
    public function testValidation($spreadSheet = 'TestData')
    {
        try {
            ...
            $testData = $readExcel->getTestData("$spreadSheet.xls",
                "InitiateCheckout",
                "E2E_V20_InitiateCheckout_OrderPosting_Authorization_Sale");
            ...
            TestCase::assertNull($exception, "E2E_V20_InitiateCheckout_OrderPosting_Authorization_Sale");
        }
    }
}
