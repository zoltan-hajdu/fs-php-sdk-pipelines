...
class E2E_V30_InitiateCheckout_OrderPosting_Authorization_VoidAuthorization
{
    public function testValidation($spreadSheet = 'TestData')
    {
        try {
            ...
            $testData = $readExcel->getTestData("$spreadSheet.xls",
                "InitiateCheckout",
                "E2E_V30_InitiateCheckout_OrderPosting_Authorization_VoidAuthorization");
            ...
            TestCase::assertNull($exception, "E2E_V30_InitiateCheckout_OrderPosting_Authorization_VoidAuthorization");
        }
    }
}
