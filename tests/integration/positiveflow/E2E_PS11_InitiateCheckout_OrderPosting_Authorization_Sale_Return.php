...
class E2E_PS11_InitiateCheckout_OrderPosting_Authorization_Sale_Return
{
    public static function test_E2E_PS11($spreadSheet = 'TestData')
    {
        ...
        try {
            ...
            $testData = $readExcel->getTestData("$spreadSheet.xls",
                "InitiateCheckout",
                "E2E_PS11_InitiateCheckout_OrderPosting_Authorization_Sale_Return");
            ...
            $_SESSION['stepData'][] =
                $reportHandler->getErrorData("Exception Message in E2E_PS11_InitiateCheckout_OrderPosting_Authorization_Sale_Return",
