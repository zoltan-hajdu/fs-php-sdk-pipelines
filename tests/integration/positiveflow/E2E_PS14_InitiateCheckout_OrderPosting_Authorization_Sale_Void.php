...
class E2E_PS14_InitiateCheckout_OrderPosting_Authorization_Sale_Void
{
    public static function test_E2E_PS14($spreadSheet = 'TestData')
    {
        ...
        try {
            ...
            $testData = $readExcel->getTestData("$spreadSheet.xls",
                "InitiateCheckout",
                "E2E_PS14_InitiateCheckout_OrderPosting_Authorization_Sale_Void");
            ...
            $_SESSION['stepData'][] =
                $reportHandler->getErrorData("Exception Message in E2E_PS14_InitiateCheckout_OrderPosting_Authorization_Sale_Void",
