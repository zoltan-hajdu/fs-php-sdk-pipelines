...
class E2E_PS13_InitiateCheckout_OrderPosting_Authorization_Sale_Reversal
{
    public static function test_E2E_PS13($spreadSheet = 'TestData')
    {
        ...
        try {
            ...
            $testData = $readExcel->getTestData("$spreadSheet.xls",
                "InitiateCheckout",
                "E2E_PS13_InitiateCheckout_OrderPosting_Authorization_Sale_Reversal");
            ...
            $_SESSION['stepData'][] =
                $reportHandler->getErrorData("Exception Message in E2E_PS13_InitiateCheckout_OrderPosting_Authorization_Sale_Reversal",
