...
require_once(__DIR__ . '/../../api/CustomerAccUpdateAPI.php');
require_once(__DIR__ . '/../../utils/ReadExcel.php');
require_once(__DIR__ . '/../../utils/ReportHandler.php');

class E2E_PS18_CustomerAccUpdate
{
    public static function test_E2E_PS18($spreadSheet = 'TestData')
    {
        ...
        try {
            ...
            $testData = $readExcel->getTestData("$spreadSheet.xls", "CustomerSearch", "E2E_PS18_CustomerAccUpdate");

            CustomerAccUpdateAPI::build($testData);
            ...
            $_SESSION['stepData'][] = $reportHandler->getErrorData("Exception Message in E2E_PS18_CustomerAccUpdate",
