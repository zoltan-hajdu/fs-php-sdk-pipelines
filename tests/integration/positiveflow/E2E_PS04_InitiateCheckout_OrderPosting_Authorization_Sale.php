...
class E2E_PS04_InitiateCheckout_OrderPosting_Authorization_Sale
{

    public static function test_E2E_PS04($spreadSheet = 'TestData')
    {
        ...
        try {
            ...
            $testData = $readExcel->getTestData("$spreadSheet.xls",
                "InitiateCheckout",
                "E2E_PS04_InitiateCheckout_OrderPosting_Authorization_Sale");
            ...
            $_SESSION['stepData'][] =
                $reportHandler->getErrorData("Exception Message in E2E_PS04_InitiateCheckout_OrderPosting_Authorization_Sale",
